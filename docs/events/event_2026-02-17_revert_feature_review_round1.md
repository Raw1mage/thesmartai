...
| `c5dc075a8`   | revert plugin exports to `dist`                                     | Fix published package import path correctness                          | Not present (`exports` currently point to `src`)                            | High priority to restore with compatibility-safe export map                  |
