...
### 短期行動 (1-2 weeks)
- 📋 Global 模組延遲初始化 (方案 A) - 預期 2-3 小時
- 📋 DEBUG logging Phase 2 (日誌級別) - 預期 1-2 小時
- 📋 測試環境改進 (Global.initialize) - 預期 30 分鐘
...
### 1-2 週內
1. 實施 Global 模組延遲初始化 (方案 A)
2. 執行 persist-account-pool.test.ts 驗證
3. 完成 DEBUG logging Phase 2 (日誌級別)
