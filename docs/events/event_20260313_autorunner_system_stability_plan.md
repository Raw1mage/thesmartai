...
- `/home/pkcs12/projects/opencode/packages/opencode/src/process/**`
- `/home/pkcs12/projects/opencode/packages/opencode/src/server/**`
- `/home/pkcs12/projects/opencode/packages/app/src/pages/session/**`
- `/home/pkcs12/projects/opencode/docs/ARCHITECTURE.md`
- `/home/pkcs12/projects/opencode/docs/events/event_20260313_autorunner_system_stability_plan.md`
...
- 已加入 `/home/pkcs12/projects/opencode/refs/clawbot/` 作為 autorunner 實作參考：
...
- planner reactivation 已完成的最小可見切片：
  ...
  - `packages/opencode/src/session/index.ts`
    - 將 planner 基地從舊的 `.opencode/plans/*.md` 遷移為 repo-native `specs/changes/<change-slug>/implementation-spec.md`
  ...
  - `packages/opencode/test/session/planner-reactivation.test.ts`
    - 新增 regression tests：
      - 驗證 planner spec path 會落在 `repo/specs/changes/.../implementation-spec.md`
...
- 驗證結果：
  - `bun test "/home/pkcs12/projects/opencode/packages/opencode/test/tool/registry.test.ts"` ✅
  ...
  - 已新增方法論文件：`/home/pkcs12/projects/opencode/docs/specs/planner_spec_methodology.md`
...
1. 已新增正式 design doc：
   - `/home/pkcs12/projects/opencode/docs/specs/autorunner_daemon_architecture.md`
2. 已新增 planning revival spec：
   - `/home/pkcs12/projects/opencode/docs/specs/planning_agent_revival.md`
3. 近期優先順序建議改為：
...
5. 已新增 planning question contract：
   - `/home/pkcs12/projects/opencode/docs/specs/planning_agent_question_contract.md`
6. 已新增 planning runtime reactivation spec：
   - `/home/pkcs12/projects/opencode/docs/specs/planning_agent_runtime_reactivation.md`
