# Refactor Plan: 2026-02-26 (origin/dev → cms, origin_dev_delta_20260226)
...
- Upstream pending (raw): 590 commits
- Excluded by processed ledger: 0 commits
- Commits for this round: 590 commits
...
| `d1ee4c8dc` | feature | 1/0/0/1=2 | low | ported | test: add more test cases for project.test.ts (#13355) |
...
| `98aeb60a7` | behavioral-fix | 1/1/0/0=2 | medium | ported | fix: ensure @-ing a dir uses the read tool instead of dead list tool (#13428) |
...
| `d01890388` | behavioral-fix | 1/1/0/0=2 | medium | ported | fix: prevent opencode run crash on malformed tool inputs (#13051) |
...
| `179c40749` | behavioral-fix | 1/1/0/0=2 | medium | ported | fix: tweak websearch tool description date info to avoid cache busts (#13559) |
...
| `67c985ce8` | behavioral-fix | 1/1/0/0=2 | medium | ported | fix: add WAL checkpoint on database open (#13633) |
...
| `eb553f53a` | behavioral-fix | 1/1/0/0=2 | medium | ported | fix: ensure sqlite migration logs to stderr instead of stdout (#13691) |
...
| `45fa5e719` | behavioral-fix | 1/1/0/0=2 | medium | ported | fix(core): remove unnecessary per-message title LLM calls (#13804) |
...
| `86e545a23` | behavioral-fix | 1/1/0/0=2 | medium | ported | fix(opencode): ACP sessions never get LLM-generated titles (#13095) |
...
| `25f3eef95` | behavioral-fix | 1/1/0/0=2 | medium | ported | fix: ensure explore subagent has external_directory perm set to ask instead of auto denying (#14060) |
...
| `3af12c53c` | behavioral-fix | 1/1/0/0=2 | medium | ported | fix(opencode): import custom tools via file URL (#14971) |
| `e71826377` | behavioral-fix | 1/1/0/0=2 | medium | ported | fix(project): await git id cache write (#14977) |
| `da40ab7b3` | behavioral-fix | 1/1/0/0=2 | medium | ported | fix(opencode): disable config bun cache in CI (#14985) |
...
| `088a81c11` | protocol | 1/0/0/0=1 | medium | ported | fix: consume stdout concurrently with process exit in auth login (#15058) |
...
| `d1ee4c8dc` | ported | - | test: add more test cases for project.test.ts (#13355) |
...
| `98aeb60a7` | ported | - | fix: ensure @-ing a dir uses the read tool instead of dead list tool (#13428) |
...
| `d01890388` | ported | - | fix: prevent opencode run crash on malformed tool inputs (#13051) |
...
| `179c40749` | ported | - | fix: tweak websearch tool description date info to avoid cache busts (#13559) |
...
| `67c985ce8` | ported | - | fix: add WAL checkpoint on database open (#13633) |
...
| `eb553f53a` | ported | - | fix: ensure sqlite migration logs to stderr instead of stdout (#13691) |
...
| `45fa5e719` | ported | - | fix(core): remove unnecessary per-message title LLM calls (#13804) |
...
| `86e545a23` | ported | - | fix(opencode): ACP sessions never get LLM-generated titles (#13095) |
...
| `25f3eef95` | ported | - | fix: ensure explore subagent has external_directory perm set to ask instead of auto denying (#14060) |
...
| `3af12c53c` | ported | - | fix(opencode): import custom tools via file URL (#14971) |
| `e71826377` | ported | - | fix(project): await git id cache write (#14977) |
| `da40ab7b3` | ported | - | fix(opencode): disable config bun cache in CI (#14985) |
...
| `088a81c11` | ported | - | fix: consume stdout concurrently with process exit in auth login (#15058) |
