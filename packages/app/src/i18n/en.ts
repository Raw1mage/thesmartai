export const dict = {
  ...
  "dialog.provider.gmicloud.note": "High-performance DeepSeek-R1 serving",
  ...
  "prompt.toast.agentRequired.description": "Choose an agent before sending a prompt. Model will be auto-selected.",
