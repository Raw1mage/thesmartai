export const dict = {
  ...
  "session.tools.launcher": "Open tools",
  "session.tools.files": "File list",
  "session.tools.monitor": "Task monitor",
  "session.tools.todo": "Todo list",
  "session.tools.terminal": "Terminal",
  ...
  "settings.accounts.summary": "{{count}} account(s) across provider families.",
  "settings.accounts.loading": "Loading...",
  "settings.accounts.empty": "No accounts found.",
  "settings.accounts.active": "Active",
  "settings.accounts.setActive": "Set active",
  "settings.accounts.cooldown": "Cooling down ({{minutes}}m)",
  "settings.accounts.type.subscription": "Subscription",
  ...
  "settings.providers.section.disabled": "Disabled providers",
  "settings.providers.disabled.empty": "No disabled providers",
  "settings.providers.section.popular": "Popular providers",
  "settings.providers.action.enable": "Enable",
  "settings.providers.action.disable": "Disabled",
  "settings.providers.environmentLocked": "Connected from your environment variables",
  ...
  "settings.providers.toast.enabled.title": "{{provider}} enabled",
  "settings.providers.toast.enabled.description": "{{provider}} is now available for model routing.",
  ...
  "settings.models.recommendations.title": "Routing recommendations",
  "settings.models.recommendations.empty": "No rotation recommendations available.",
  "settings.models.recommendations.apply": "Apply",
  "settings.models.recommendations.cooldown": "Cooling down ({{minutes}}m)",
  "settings.models.recommendations.toast.applied.title": "Recommendation applied",
  "settings.models.recommendations.toast.applied.description": "{{task}} → {{value}}",
  "settings.models.recommendations.toast.failed.title": "Failed to apply recommendation",
  ...
  "app_market.tools_count": "{{count}} tools",
  "app_market.status.available": "Available",
  "app_market.status.pending_install": "Not Installed",
  "app_market.status.pending_auth": "Auth Required",
  "app_market.status.pending_config": "Config Required",
  "app_market.status.disabled": "Disabled",
  "app_market.status.ready": "Ready",
  "app_market.status.error": "Error",
  "app_market.action.install": "Install",
  "app_market.action.connect": "Connect",
  "app_market.action.enable": "Enable",
  "app_market.action.disable": "Disable",
  "app_market.action.repair": "Repair",
  "app_market.action.open": "Open",
  "app_market.action.loading": "...",
  "app_market.action.uninstall": "Uninstall",
}
