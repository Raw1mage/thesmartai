...
export const dict = {
  ...
  "provider.connect.oauth.code.visit.suffix":
    " 并手动打开此链接获取授权码，以连接你的帐户并在 OpenCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "，手动打开后输入以下代码，以连接你的帐户并在 OpenCode 中使用 {{provider}} 模型。",
  ...
  "session.tab.review": "异动清单",
  "session.tab.context": "上下文",
  "session.panel.reviewAndFiles": "异动清单和文件",
  ...
  "session.review.empty": "当前 Git 没有未提交变更",
  "session.review.noChanges": "没有 Git 变动",
  ...
  "settings.providers.section.disabled": "已禁用的提供商",
  "settings.providers.disabled.empty": "没有已禁用的提供商",
  "settings.providers.section.popular": "热门提供商",
  "settings.providers.action.enable": "启用",
  "settings.providers.action.disable": "已禁用",
  "settings.providers.environmentLocked": "通过环境变量连接",
  "settings.providers.custom.title": "自定义提供商",
  "settings.providers.custom.description": "通过 Base URL 添加 OpenAI 兼容提供商。",
  "settings.providers.toast.enabled.title": "{{provider}} 已启用",
  "settings.providers.toast.enabled.description": "{{provider}} 现在可用于模型路由。",
  ...
  "status.popover.tab.accounts": "账户",

  "common.refresh": "刷新",
  "common.manage": "管理",

  "settings.accounts.title": "账户",
  "settings.accounts.summary": "跨 provider 家族共 {{count}} 个账户。",
  "settings.accounts.loading": "加载中...",
  "settings.accounts.empty": "未找到账户。",
  "settings.accounts.active": "当前",
  "settings.accounts.setActive": "设为当前",
  "settings.accounts.cooldown": "冷却中（{{minutes}} 分钟）",
  "settings.accounts.type.subscription": "订阅",
  ...
  // App Market
  "app_market.title": "应用市场",
  "app_market.description": "已安装 {{installed}} / 共 {{total}} 个",
  "app_market.card.description": "说明：{{description}}",
  "app_market.search.placeholder": "搜索应用...",
  "app_market.loading": "加载中...",
  "app_market.empty": "找不到应用",
  "app_market.tools_count": "{{count}} 个工具",
  "app_market.status.available": "可安装",
  "app_market.status.pending_install": "未安装",
  "app_market.status.pending_auth": "需要授权",
  "app_market.status.pending_config": "需要配置",
  "app_market.status.disabled": "已停用",
  "app_market.status.ready": "就绪",
  "app_market.status.error": "错误",
  "app_market.action.install": "安装",
  "app_market.action.connect": "连接",
  "app_market.action.enable": "启用",
  "app_market.action.disable": "停用",
  "app_market.action.repair": "修复",
  "app_market.action.open": "打开",
  "app_market.action.loading": "...",
  "app_market.action.uninstall": "卸载",
