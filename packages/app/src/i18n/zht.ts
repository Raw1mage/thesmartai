...
export const dict = {
  ...
  "command.provider.connect": "模型提供者",
  ...
  "session.tools.launcher": "開啟工具",
  "session.tools.files": "檔案清單",
  ...
  "dialog.model.select.title": "模型管理員",
  ...
  "dialog.model.mode.favorites": "顯示我的最愛",
  "dialog.model.mode.all": "全部",
  "dialog.model.mode.curated": "精選",
  "dialog.model.activity.unavailable": "不可用",
  "dialog.model.activity.providerDisabled": "提供者已停用",
  "dialog.model.activity.selectBlocked": "此模型目前不可用",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " 並手動開啟連結取得授權碼，以連線你的帳戶並在 OpenCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "，手動開啟後輸入以下程式碼，以連線你的帳戶並在 OpenCode 中使用 {{provider}} 模型。",
  ...
  "common.favorites": "我的最愛",
  "common.providers": "提供者",
  "common.all": "所有模型",
  ...
  "session.tab.review": "異動清單",
  "session.tab.context": "上下文",
  "session.panel.reviewAndFiles": "異動清單與檔案",
  ...
  "session.review.empty": "目前 Git 沒有未提交變更",
  "session.review.noChanges": "沒有 Git 變動",
  ...
  "settings.providers.section.disabled": "已停用的提供商",
  "settings.providers.disabled.empty": "沒有已停用的提供商",
  "settings.providers.section.popular": "熱門提供商",
  "settings.providers.action.enable": "啟用",
  "settings.providers.action.disable": "已停用",
  "settings.providers.environmentLocked": "透過環境變數連線",
  "settings.providers.custom.title": "自訂提供商",
  "settings.providers.custom.description": "透過 Base URL 新增 OpenAI 相容提供商。",
  "settings.providers.toast.enabled.title": "{{provider}} 已啟用",
  "settings.providers.toast.enabled.description": "{{provider}} 現在可用於模型路由。",
  ...
  "settings.models.recommendations.title": "路由建議",
  "settings.models.recommendations.empty": "目前沒有可用的輪替建議。",
  "settings.models.recommendations.apply": "套用",
  "settings.models.recommendations.cooldown": "冷卻中（{{minutes}} 分鐘）",
  "settings.models.recommendations.toast.applied.title": "已套用建議",
  "settings.models.recommendations.toast.applied.description": "{{task}} → {{value}}",
  "settings.models.recommendations.toast.failed.title": "套用建議失敗",
  ...
  "settings.accounts.title": "帳號",
  "settings.accounts.summary": "跨 provider 家族共有 {{count}} 個帳號。",
  "settings.accounts.loading": "載入中...",
  "settings.accounts.empty": "找不到任何帳號。",
  "settings.accounts.active": "目前啟用",
  "settings.accounts.setActive": "設為啟用",
  "settings.accounts.cooldown": "冷卻中（{{minutes}} 分鐘）",
  "settings.accounts.type.subscription": "訂閱",
  "settings.accounts.type.oauth": "OAuth",
  "settings.accounts.type.api": "API",
  "settings.accounts.toast.updated.title": "已更新啟用帳號",
  "settings.accounts.toast.updated.description": "{{provider}} → {{account}}",
  "settings.accounts.toast.switchFailed": "切換帳號失敗",
  ...
  "app_market.tools_count": "{{count}} 個工具",
  "app_market.status.available": "可安裝",
  "app_market.status.pending_install": "未安裝",
  "app_market.status.pending_auth": "需要授權",
  "app_market.status.pending_config": "需要設定",
  "app_market.status.disabled": "已停用",
  "app_market.status.ready": "就緒",
  "app_market.status.error": "錯誤",
  "app_market.action.install": "安裝",
  "app_market.action.connect": "連結",
  "app_market.action.enable": "啟用",
  "app_market.action.disable": "停用",
  "app_market.action.repair": "修復",
  "app_market.action.open": "開啟",
  "app_market.action.loading": "...",
  "app_market.action.uninstall": "解除安裝",
