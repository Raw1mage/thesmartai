...
export function createAntigravityFetch(
  getAuth: GetAuth,
  client: PluginContext["client"],
  options: { singleAccountMode?: boolean } = {},
  ...
  return async (input: RequestInfo | URL, init?: RequestInit): Promise<Response> => {
    const normalizedInput: RequestInfo = input instanceof URL ? input.toString() : input;
    console.log("ANTIGRAVITY FETCH ENTRY:", toUrlStr(normalizedInput));
    ...
    console.log("ANTIGRAVITY FETCH: URL", urlString, "Family:", family);
