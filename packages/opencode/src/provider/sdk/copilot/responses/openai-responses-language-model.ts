...
// AI SDK 6: using optional() instead of nullish() to align with TypeScript best practices
// optional() accepts undefined but not null, which is the standard pattern for optional fields
