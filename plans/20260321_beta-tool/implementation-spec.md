...
- Teach builder to understand beta-loop lifecycle stages: beta bootstrap, beta worktree execution, commit/push/pull coordination, syncback-based validation, and approval-gated merge finalize.
