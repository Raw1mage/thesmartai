...
1. **官方文件（聖經）**：https://developers.openai.com/api/docs
2. **Golden reference**：`golden-request.json`（request）— 需補 response golden
3. **AI SDK adapter**：`openai-responses-language-model.ts`（1733 行）
