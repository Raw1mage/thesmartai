...
1. Use `specs/_archive/agent_framework/` as the canonical semantic root.
...
- Canonical entry files at `specs/_archive/agent_framework/`.
- Preserved supporting roots under `specs/_archive/agent_framework/sources/`.
