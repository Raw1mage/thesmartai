...
The repository SHALL treat `specs/_archive/agent_framework/` as the semantic entry root for agent runtime taxonomy.
...
- **THEN** they start at `specs/_archive/agent_framework/`
...
- **THEN** all merged roots remain available under `specs/_archive/agent_framework/sources/`
