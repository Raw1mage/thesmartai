...
- **下游 spec（尚未建立）**：`/specs/_archive/codex-prompt-rebuild-incremental/` 會在本 spec 完成驗證後銜接，處理同檔 `transport-ws.ts` 的 prompt rebuild 熱點。參見 `docs/events/event_20260424_codex_session_cpu_burn.md`。
