...
7. **Sync after every checkbox.** 每勾完一條跑 `bun run ~/projects/skills/plan-builder/scripts/plan-sync.ts specs/_archive/docxmcp-http-transport/`。
...
11. [specs/_archive/repo-incoming-attachments/design.md](../repo-incoming-attachments/design.md) — 撤掉的 DD-3/5/11/15/16 原文 + 保留的 DD-1/2/6/7/8/12/13/14/17
