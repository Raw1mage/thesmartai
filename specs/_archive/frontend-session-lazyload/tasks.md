...
§1–§6 內可並行做但不跨 phase。每個 phase 完成後執行 `bun run ~/projects/skills/plan-builder/scripts/plan-sync.ts specs/_archive/frontend-session-lazyload/`，依 drift 決定下一步（plan-builder §16.3）。
