...
6. **Sync after each task** — run `bun run ~/.claude/skills/plan-builder/scripts/plan-sync.ts specs/_archive/mandatory-skills-preload/` after every checkbox toggle.
...
- `specs/_archive/mandatory-skills-preload/data-schema.json` (contracts for parser outputs + events)
- `specs/_archive/mandatory-skills-preload/sequence.json` (runtime flow diagrams)
...
- [ ] `specs/_archive/mandatory-skills-preload/.state.json` is at `planned` state (NOT `designed` or `implementing`)
...
1. Mark `- [x]` immediately in `specs/_archive/mandatory-skills-preload/tasks.md`
2. Run `bun run ~/.claude/skills/plan-builder/scripts/plan-sync.ts specs/_archive/mandatory-skills-preload/`
