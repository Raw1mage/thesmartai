...
- `specs/_archive/responsive-orchestrator/idef0.json` — A0 system context, A1-A5
  decomposition (dispatch / run / detect-finish / inject / cancel)
- `specs/_archive/responsive-orchestrator/grafcet.json` — state machine for
  subagent worker lifecycle and task tool dispatch
- `specs/_archive/responsive-orchestrator/c4.json` — main session, subagent
  worker, task tool, watchdog, subscriber, prompt
- `specs/_archive/responsive-orchestrator/sequence.json` — happy path, IPC-sever,
