...
1. Mark `- [x]` in mainRepo `specs/attachment-lifecycle/tasks.md`
2. Run `bun run /home/pkcs12/.claude/skills/plan-builder/scripts/plan-sync.ts specs/attachment-lifecycle/`
3. Read sync output:
   - `clean` → next task
