...
- [x] Record this work into a planner artifact set under `specs/changes/20260315-web-monitor-restart-control/`
...
- [x] Refactor planner package layout from `specs/changes/<slug>/` to `specs/<date>_<plan-title>/`
