...
- [x] 4.2 Implement test that loads `specs/claude-provider-beta-fingerprint-realign/test-vectors.json` and asserts `assembleBetas(input).toEqual(expected)` per case
...
- [x] 4.6 Add a "Research outcomes" pointer in protocol-datasheet.md to `specs/claude-provider-beta-fingerprint-realign/design.md` § Research Outcomes
