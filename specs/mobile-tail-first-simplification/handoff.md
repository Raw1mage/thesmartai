...
- Spec artifacts (`specs/mobile-tail-first-simplification/**`, `docs/events/**`) are edited in `mainRepo`, never in beta.
...
- `specs/mobile-tail-first-simplification/spec.md` — full Requirements list
- `specs/mobile-tail-first-simplification/design.md` — DD-1 through DD-10, **especially DD-8 removal inventory**
- `specs/mobile-tail-first-simplification/sequence.json` — P1..P5 flows
- `specs/frontend-session-lazyload/spec.md` — to understand what R1/R2 will be superseded
