...
- [ ] 8.4 Promote `specs/frontend-session-lazyload` via plan-builder amend mode: mark R1 + R2 + cursor/pagination sections `[SUPERSEDED by mobile-tail-first-simplification]`
