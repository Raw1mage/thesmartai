...
- [ ] 6.2 `bun run ~/projects/skills/plan-builder/scripts/plan-promote.ts specs/question-tool-input-normalization/ --to verified --reason "all phases green; evidence in event log"`
