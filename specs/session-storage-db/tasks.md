...
- [ ] 5.1 Add `storage/dreaming.ts` (`DreamingWorker`): periodic timer (default 5000ms tick), idle detector (no message-write in `IDLE_THRESHOLD_MS`), legacy-session inventory scanner
